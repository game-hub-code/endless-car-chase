function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Endless_Car_Chase.loader.js";
		var config = {
        dataUrl: buildUrl + "/Endless_Car_Chase.data",
        frameworkUrl: buildUrl + "/Endless_Car_Chase.framework.js",
        codeUrl: buildUrl + "/Endless_Car_Chase.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Endless Car Chase",
        productVersion: "1.0",
      };
